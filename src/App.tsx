...
export const App: React.FC = () => {
  ...
  const [projects, setProjects] = useState<ProjectData[]>([
    ...
    },
    {
      ...
      title: 'TravelConnect',
      status: 'IN PROGRESS',
      description: 'A travel-focused platform project.',
    ...
    },
    {
      ...
      status: 'ARCHIVED',
      description: 'A Pokémon-themed portfolio built in React/Tailwind exploring dark-mode glassmorphism and trainer-card visual concepts.',
      techStack: ['React', 'Tailwind CSS', 'Framer Motion', 'Webpack'],
      githubUrl: 'https://github.com',
    },
    {
      id: 'esp32-hobby',
            ...
            <div className="space-y-6 relative border-l border-faded-ash/20 pl-6 ml-1">
              ...
              <div className="relative">
                ...
                <p className="text-sm md:text-base text-aged-vellum/90 font-inter leading-relaxed">
                  Built a document conversion engine handling DOC, DOCX, and PDF to HTML at scale — the core pipeline behind several downstream tools
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-sm md:text-base text-aged-vellum/90 font-inter leading-relaxed">
                  Built Aikira Lite, an AI-assisted editorial workflow tool
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-sm md:text-base text-aged-vellum/90 font-inter leading-relaxed">
                  Built analytics for paper-mill detection — identifying patterns of fraudulent or mass-produced academic papers
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-sm md:text-base text-aged-vellum/90 font-inter leading-relaxed">
                  Built automation for supplementary file handling in editorial pipelines
                </p>
              </div>
